...
| [0049](0049-policy-rules-as-first-class-objects.html) | Policy rules as first-class objects — a rule is a standard in force over a period, evaluated at read into findings that carry no action | Accepted (gate B3.6, FR-43; owner sign-off = the merge of the Sprint 15 planning PR) |
