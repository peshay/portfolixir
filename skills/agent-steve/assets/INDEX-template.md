...
## Session Logs
- `sessions/` — raw session notes by date (YYYY-MM-DD.md), distilled into MEMORY.md at session close

## My Files
_This section grows as I create organic files (e.g. a `design-language.md` once it outgrows MEMORY.md). Update it when adding new files._
