...
| A4 | p95 < 2 s holds with derive-on-read | Medium | High | Proven on a real-world export of several thousand bookings over many years (ADR-0010 amendment), but benchmark × what-if × daily walks stack; caching-ADR trigger metric undefined; no volume fixtures or benchmark exist in the repo today |
