...
- **E24 — Policy rules** — *phase 3 (agent-first), now.* Tracker filed at branch
  opening (Sprint 15 Lane Z), under area #418; decision in **ADR-0049** (gate
  ...
  stay shut. FR-43; FR-48 becomes reachable without a findings store.
