...
- **User's hard condition (Steve):** a settable default view (household case:
  "mine" vs. "partner's" without a hard wall). Explicitly NOT needed:
...
Not executed (requires the live instance and Andi); scheduled after #557
merges. Agenda unchanged from the prep doc: credit_line/reserve roles for the
Lombard/Tagesgeld accounts; repair negative holdings (#570 will surface them);
